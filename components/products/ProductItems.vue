...
const products = ref([
  ...
  {id: 3, title: 'Телеграм-боты', subtitle:'Элегантный способ автоматизировать многие процессы, например бронирование время записи, создание онлайн-меню и создание интернет-магазина с оформлением и обработкой заявок'},
