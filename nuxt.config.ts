    ...
    app: {
        ...
        head: {
            ...
            meta: [
                ...
                { name: 'description', content: 'У нас вы сможете заказать разработку веб сайта или телеграм-бота. Профессиональная разработка сайтов в Омске. ☎ +7 996 219 85 46' },
                ...
                { property: "og:site_name", content: 'Компания разработки сайтов WaffleWeb'},
                { property: "og:site_name", content: 'Компания разработки сайтов WaffleWeb'},
                { property: "og:description", content: 'У нас вы сможете заказать разработку веб сайта или телеграм-бота. Профессиональная разработка сайтов в Омске. ☎ +7 996 219 85 46'},
            ],
            link: [
                { rel: 'canonical', href: 'https://www.waffle-web.ru'},
                { rel: 'alternate', type:'application/rss+xml', title: 'Компания разработки сайтов WaffleWeb', href: 'https://www.waffle-web.ru'},
